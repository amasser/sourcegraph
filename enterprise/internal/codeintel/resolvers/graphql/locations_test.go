...
func TestResolveLocations(t *testing.T) {
	...
	r1 := lsp.Range{Start: lsp.Position{Line: 11, Character: 12}, End: lsp.Position{Line: 13, Character: 14}}
	r2 := lsp.Range{Start: lsp.Position{Line: 21, Character: 22}, End: lsp.Position{Line: 23, Character: 24}}
	r3 := lsp.Range{Start: lsp.Position{Line: 31, Character: 32}, End: lsp.Position{Line: 33, Character: 34}}
	r4 := lsp.Range{Start: lsp.Position{Line: 41, Character: 42}, End: lsp.Position{Line: 43, Character: 44}}
