...
func NewMockQueryResolver() *MockQueryResolver {
	return &MockQueryResolver{
		...
		HoverFunc: &QueryResolverHoverFunc{
			defaultHook: func(context.Context, int, int) (string, golsp.Range, bool, error) {
				return "", golsp.Range{}, false, nil
			},
		},
		ReferencesFunc: &QueryResolverReferencesFunc{
...
type QueryResolverHoverFunc struct {
	defaultHook func(context.Context, int, int) (string, golsp.Range, bool, error)
	hooks       []func(context.Context, int, int) (string, golsp.Range, bool, error)
...
func (m *MockQueryResolver) Hover(v0 context.Context, v1 int, v2 int) (string, golsp.Range, bool, error) {
...
func (f *QueryResolverHoverFunc) SetDefaultHook(hook func(context.Context, int, int) (string, golsp.Range, bool, error)) {
	f.defaultHook = hook
}
...
func (f *QueryResolverHoverFunc) PushHook(hook func(context.Context, int, int) (string, golsp.Range, bool, error)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefaultReturn calls SetDefaultDefaultHook with a function that returns
// the given values.
func (f *QueryResolverHoverFunc) SetDefaultReturn(r0 string, r1 golsp.Range, r2 bool, r3 error) {
	f.SetDefaultHook(func(context.Context, int, int) (string, golsp.Range, bool, error) {
		return r0, r1, r2, r3
	})
}
...
// PushReturn calls PushDefaultHook with a function that returns the given
// values.
func (f *QueryResolverHoverFunc) PushReturn(r0 string, r1 golsp.Range, r2 bool, r3 error) {
	f.PushHook(func(context.Context, int, int) (string, golsp.Range, bool, error) {
		return r0, r1, r2, r3
	})
}

func (f *QueryResolverHoverFunc) nextHook() func(context.Context, int, int) (string, golsp.Range, bool, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
